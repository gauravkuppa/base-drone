...
void PID::setTunings(double Kp, double Ki, double Kd){
    double SampleTimeInSec = ((double)sampleTime)/200000; //Figure this conversion out
    this->k_p = Kp;
    this->k_i = Ki*SampleTimeInSec;
    this->k_d = Kd/SampleTimeInSec;
