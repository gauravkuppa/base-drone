...
void entry_point(void) {
  ...
  /* RTOS trace is an optional component enabled by the following macro at
   * FreeRTOSConfig.h
  ...
  // If RTOS trace is compiled in (configUSE_TRACE_FACILITY) then enable it at
  // this point before entering main()
